...
/data
 ...
 ├── logs/           # run-logs
Deze structuur is leidend. Scripts mogen hier niet van afwijken zonder expliciete reden.
...
Slot
Als iets niet eenvoudig uit te leggen is aan een nieuwe engineer, dan hoort het hier niet thuis.
